...
<input type="number" id="wc" name="propiedad[wc]" placeholder="Ej. 1" min="1" max="9" value="<?php echo sanitizar( $propiedad->wc ); ?>">
<label for="estacionamiento">Estacionamiento:</label>
<input type="number" id="estacionamiento" name="propiedad[estacionamiento]" placeholder="Ej. 1" min="1" max="9" value="<?php echo sanitizar ( $propiedad->estacionamiento ); ?>">
