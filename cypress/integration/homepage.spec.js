...
describe('Carga la página principal', () => {
    it('Prueba el header de la pagina principal', () => {
        ...
        cy.get('[data-cy="heading-sitio"]').invoke('text').should('equal', 'Venta de casas y departamentos suculentos');
    ...
    it('Prueba la sección de propiedade', () => {
        ...
        cy.get('[data-cy="enlace-propiedades"]').should('have.class', 'boton-amarillo-block');
        cy.get('[data-cy="enlace-propiedades"]').should('not.have.class', 'boton-verde');
    ...
    it('Prueba el bolque de contacto', () =>{
        ...
        cy.get('[data-cy="imagen-contacto"]').find('a').first().invoke('attr', 'href')
        .then( href =>  {
            cy.visit(href);
        });
